...
public class cate6 extends AppCompatActivity {

    private static final String PHP_SCRIPT_URL = "http://192.168.33.224/cate6.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cate_6);
        ...
        dookreadingButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // 독후감Activity로 이동
                Intent intent = new Intent(cate6.this, book_write_main.class);
        ...
        homeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // mainActivity로 이동
                Intent intent = new Intent(cate6.this, HomeActivity.class);
                startActivity(intent);
            }
        });
        ...
        HeartButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // mainActivity로 이동
                Intent intent = new Intent(cate6.this, jjim.class);
                startActivity(intent);
            }
        });
        ...
        mypageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // mypageActivity로 이동
                Intent intent = new Intent(cate6.this, mypage.class);
                startActivity(intent);
            }
        });
        ...
        txtSearch.setOnClickListener(view -> {
            Intent intent = new Intent(cate6.this, search.class);
            startActivity(intent);
        });
    }
    ...
    private void setRecordData(JSONObject record, TextView textView, ImageView imageView) throws Exception {
        ...
        imageView.setOnClickListener(view -> {
            Intent intent = new Intent(cate6.this, com.example.book.bookinfo.book_info.class);
